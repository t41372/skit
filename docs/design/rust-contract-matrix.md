...
| Settings, preferences, health, the Preferences agent list, Agent Skill, and dirty guards | Complete | application/UI/TUI transaction and responsive-management owners plus pinned-main manifests |
