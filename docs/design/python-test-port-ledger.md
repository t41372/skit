...
| Python module | # | Rust target | Status |
| --- | --- | --- | --- |
| test_flows.py | 102 | crates/skit-application/tests/port_test_flows.rs + crates/skit-ui/tests/run_screen.rs | done (61) · 41 cross-crate · three inject-field projection owners moved to the real `RunFormView::from_declarations` seam `f5423d4` with typed default/control/secret/env/binding assertions · remaining plan_for_entry/execute/transparency → skit-cli and exact messages → skit-tui · divergences kept |
