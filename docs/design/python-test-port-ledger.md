...
| Python module | # | Rust target | Status |
| --- | --- | --- | --- |
| test_prompt_tui.py | 83 | crates/skit-tui/tests/port_test_prompt_tui.rs + crates/skit-cli/tests/terminal_pty.rs | done (51) · real MouseDown runner selection strengthened and pinned/unpinned rerun moved to the live TUI host `f8091da` with child markers and last-value replay · selected-runner preflight return-to-Library remains a production blocker · **Library title FIXED 5574ff1** (工具库/庫) · remaining cross-crate run routing · Ctrl+O/Ctrl+E divergences in fix pass |
