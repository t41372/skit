...
| `2` | usage error — bad flag combination, unknown `--set` name, unknown preset, or any flag skit cannot honour (`skit params` refuses the whole invocation and writes nothing) |
