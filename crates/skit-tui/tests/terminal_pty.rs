...
#[test]
#[ignore = "runs only as the child of the delayed-start PTY owner"]
fn delayed_collect_form_child() {
...
#[test]
fn initial_pty_marker_can_arrive_after_an_idle_poll() {
    run_child_in_pty("delayed_collect_form_child", None, "Name", &[]);
}
    ...
    loop {
        ...
        match watch.receive(remaining) {
            ...
            Err(mpsc::RecvTimeoutError::Disconnected) => panic!(
                "PTY output closed before the generic form appeared: {}",
