...
impl<Focus, Reflow> AlignmentSignature<Focus, Reflow> {
    pub(crate) const fn focus(&self) -> &Focus {
        &self.focus
    }

    pub(crate) const fn viewport_width(&self) -> u16 {
        self.viewport_width
    }

    pub(crate) const fn viewport_height(&self) -> u16 {
        self.viewport_height
    }

    pub(crate) const fn reflow(&self) -> &Reflow {
        &self.reflow
    }
}
