//! Exact-name audit for frozen `tests/test_prompt_tui.py`.
//!
//! Textual-vs-Ratatui is not an architecture closure by itself. Equivalent public
//! reducer/session/event/store behavior stays executable, including deliberate red tests.
...
const OWNERS:&[&str]=&[
    ...
    "crates/skit-tui/tests/port_test_prompt_tui_review_edit_lifecycle.rs",
    ...
    "crates/skit-cli/tests/port_test_prompt_tui_pty_host_boundaries.rs",
    "crates/skit-tui/tests/port_test_prompt_tui_wrapper.rs",
    "crates/skit-cli/tests/port_test_prompt_tui_pty_edit_boundaries.rs",
];
...
fn prompt_tui_frozen_name_audit_is_complete(){
 ...
 assert_eq!(actual.len(),83,"Prompt-TUI must keep all frozen names executable");
}
